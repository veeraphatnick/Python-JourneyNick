...
if __name__=="__main__":
    ...
    get_status_lookup = authenticate_twitter_app().statuses_lookup(1100492162830000129)._json
    get_status_lookup = json.dumps(get_status_lookup, indent=5)
    print(get_status_lookup)
